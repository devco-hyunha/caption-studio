...
//;(function($,Do,Wn,WebFont,Shortkey,Player,Video,Interface,Ev,Fn,Sheet,SheetTrigger,Subtitle){
	var Do=$(document),Wn=$(window),Player={},Video={},Interface={},Fn={},Sheet={},SheetTrigger={},Shortkey=$.Shortcuts,Subtitle={};
	...
	Subtitle.Export = {
		CLASS : {
			...
			'CNCC' : 'Name:Chinese; lang:zh-CN; SAMIType:CC;',
	...
	*/
	...
	Sheet.Edit = {
		State : false,
		TimeControl : (function(timeEditor,timeParts,timeSliders,milliSecond,timePositive){
	...
	Sheet.DrawHTML = {
		smi : (function(drawData,drawCount,drawHeight,drawTimeline,drawRange,drawHtml){
			drawHtml='',
	...
	Do.on('ready', function(){
		...
		WebFont.load({
			...
			active: (function(color, format, language, data) {
				...
				if (!language || language == '') language = Sheet.Language;
